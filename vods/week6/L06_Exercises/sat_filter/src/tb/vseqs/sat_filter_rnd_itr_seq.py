...
class sat_filter_rnd_itr_seq(sat_filter_tb_base_seq):
    ...
    def __init__(self, name="ssdt_b2b_rand_n_seq"):
        ...
        self.itr_nbr = vsc.rand_uint32_t()
    ...
    async def body(self):
        ...
        uvm_root().logger.info(f"{'-'*30} Launching {self.itr_nbr} sequences. {'-'*30}")
    ...
    def itr_nbr_c(self):
        self.itr_nbr > 0
        self.itr_nbr <= _MAX_SEQS_NUMBER_
